...
import 'package:flutter_app/pages/connections/connections_events.dart';
...
class ConnectionsViewModel extends ViewModel<ConnectionsView, ConnectionsState, ConnectionsEvent> {

  final DeviceApi _devicesApi = DeviceApi();
  List<ConnectedDevice> connectedDevices = [];

  ConnectionsViewModel({required ConnectionsView view}) : super(view: view);
